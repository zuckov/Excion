...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url('content/rt/css/bootstrap.min.css');?>" rel="stylesheet">
  </head>
  <style>
...
<hr>
  ...
  <script src="<?php echo base_url('content/rt/js/jquery-1.11.2.min.js');?>"></script>
  <script src="<?php echo base_url('content/rt/js/bootstrap.min.js');?>"></script>
    ...
    $("#submit").click(function(){
      ...
      $( "#load" ).show();
       ...
       var dataString = {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('index.php/send/submit');?>",
            data: dataString,
            dataType: "json",
            cache : false,
