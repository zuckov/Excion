...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="<?php echo base_url(); ?>content/gen/vendors/animate.css/animate.min.css" rel="stylesheet">
            ...
            <form>
              ...
              <div class="separator">
                <p class="change_link">Already a member ?
                  <a href="#signin" class="to_register"> Log on </a>
                </p>
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Gentelella Alela!</h1>
                  <img src="<?php base_url(); ?>content/excionlogo1.png" alt="logo">
                  <p>©2016 All Rights Reserved. Gentelella Alela! is a Bootstrap 3 template. Privacy and Terms</p>
                </div>
              </div>
            </form>
