...
<html lang="en-US">
    <head>
        ...
        <link rel="stylesheet" type="text/css"  href="<?php base_url(); ?>content/suppablog/css/clear.css" />
        <link rel="stylesheet" type="text/css"  href="<?php base_url(); ?>content/suppablog/css/common.css" />
        <link rel="stylesheet" type="text/css"  href="<?php base_url(); ?>content/suppablog/css/font-awesome.min.css" />
        <link rel="stylesheet" type="text/css"  href="<?php base_url(); ?>content/suppablog/css/carouFredSel.css" />
        <link rel="stylesheet" type="text/css"  href="<?php base_url(); ?>content/suppablog/css/sm-clean.css" />
        <link rel="stylesheet" type="text/css"  href="<?php base_url(); ?>content/suppablog/style.css" />
